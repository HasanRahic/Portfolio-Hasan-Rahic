          ...
          <div className="btn-links">
            <div className="github">
              <AnimatedOnScroll animationIn="fadeInLeft">
                ...
                <a href="https://github.com/HasanRahic"><button className='icon-button-center'><FaGithub /> GitHub</button></a>
              </AnimatedOnScroll>
            </div>
            <div className="linkedin">
              <AnimatedOnScroll animationIn="fadeInRight">
                ...
                <a href="https://www.linkedin.com/in/hasan-rahic-3941b2255/"><button className='icon-button-center'><FaLinkedin /> LinkedIn</button></a>
              </AnimatedOnScroll>
            </div>
            <div className="mail">
              <AnimatedOnScroll animationIn="fadeInLeft">
                ...
                <a href="mailto:hasanrahic604@gmail.com"><button className='icon-button-center'><FaEnvelope /> Mail</button></a>
              </AnimatedOnScroll>
            </div>
          </div>
        </div>
